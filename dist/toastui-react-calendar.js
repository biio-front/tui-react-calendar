...
(function(global2, factory) {
  ...
  l$3.event = function(n2) {
    return H && (n2 = H(n2)), n2.persist = Z, n2.isPropagationStopped = Y, n2.isDefaultPrevented = q$4, n2.nativeEvent = n2;
  };
  ...
  var r = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i, n$3 = /[&<>"]/;
  function o(e2) {
    var t2 = String(e2);
    return n$3.test(t2) ? t2.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;") : t2;
  }
  ...
  var c = { shallow: true }, p$4 = [], _ = /^(area|base|br|col|embed|hr|img|input|link|meta|param|source|track|wbr)$/, d = /[\s\n\\/='"\0<>]/;
  function v() {
    this.__d = true;
  }
  m$3.render = m$3;
  var g$5 = function(e2, t2) {
    return m$3(e2, t2, c);
  }, h$4 = [];
  function m$3(t2, r2, n2) {
    r2 = r2 || {}, n2 = n2 || {};
    var o2 = l$3.__s;
    l$3.__s = true;
    var a2 = x(t2, r2, n2);
    return l$3.__c && l$3.__c(t2, h$4), h$4.length = 0, l$3.__s = o2, a2;
  }
    ...
    if (typeof w2 == "function") {
      if (C2 = true, !l2.shallow || !c2 && l2.renderRootComponent !== false) {
        ...
        if (w2.prototype && typeof w2.prototype.render == "function") {
          ...
          (j2 = r2.__c = new w2(O2, $2)).__v = r2, j2._dirty = j2.__d = true, j2.props = O2, j2.state == null && (j2.state = {}), j2._nextState == null && j2.__s == null && (j2._nextState = j2.__s = j2.state), j2.context = $2, w2.getDerivedStateFromProps ? j2.state = f$4(f$4({}, j2.state), w2.getDerivedStateFromProps(j2.props, j2.state)) : j2.componentWillMount && (j2.componentWillMount(), j2.state = j2._nextState !== j2.state ? j2._nextState : j2.__s !== j2.state ? j2.__s : j2.state), F2 && F2(r2), H2 = j2.render(j2.props, j2.state, j2.context);
        } else
        ...
        return j2.getChildContext && (n2 = f$4(f$4({}, n2), j2.getChildContext())), l$3.diffed && l$3.diffed(r2), x(H2, n2, l2, l2.shallowHighOrder !== false, g2, h2);
      }
      w2 = (k2 = w2).displayName || k2 !== Function && k2.name || function(e2) {
        var t2 = (Function.prototype.toString.call(e2).match(/^\s*function\s+([^( ]+)/) || "")[1];
        if (!t2) {
          for (var r3 = -1, n3 = p$4.length; n3--; )
            if (p$4[n3] === e2) {
              r3 = n3;
              break;
            }
          r3 < 0 && (r3 = p$4.push(e2) - 1), t2 = "UnnamedComponent" + r3;
        }
        return t2;
      }(k2);
    }
  ...
  class CalendarCore {
    ...
    renderToString() {
      return m$3(/* @__PURE__ */ h$3(CalendarContainer, {
        theme: this.theme,
        store: this.store,
        eventBus: this.eventBus
      }, this.getComponent()));
  ...
  function isEqual(a2, b2) {
    ...
    if (a2 && b2 && typeof a2 === "object" && typeof b2 === "object") {
      ...
      for (let i2 = 0; i2 < length; i2 += 1) {
        const key = keys[i2];
        if (!hasOwnProp(b2, key) || !isEqual(a2[key], b2[key])) {
          return false;
        }
      }
      return true;
